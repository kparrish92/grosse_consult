...
Overall, the model's conditional r squared value suggests that the model explained `r round(r2_bayes(mod)[["R2_Bayes"]], digits = 2)` percent of the variance observed in the data. 
