...
For example, by adding session 5 (.47) to our intercept (-3.19), we get adjust for session while maintaining group (comparison). 
...
eff_df %>% 
  ...
  scale_fill_manual(values=c("#5915bf", "#594e4c", "#62b57e")) +
